...
def plot(t_span, sat2_xhist, est_xhist, est_Phist):
    ...
    ax = axs[0,0]
    ax.plot(t_span, err[0], label='Error', c='blue')
    ...
    ax = axs[0,1]
    ax.plot(t_span, err[1], label='Error', c='blue')
    ...
    ax = axs[0,2]
    ax.plot(t_span, err[2], label='Error', c='blue')
    ...
    ax = axs[1,0]
    ax.plot(t_span, err[3], label='Error', c='blue')
    ...
    ax = axs[1,1]
    ax.plot(t_span, err[4], label='Error', c='blue')
    ...
    ax = axs[1,2]
    ax.plot(t_span, err[5], label='Error', c='blue')
